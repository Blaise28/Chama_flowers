...
const open_add_flower_modal = document.querySelector(".open_modal_add_flower");
open_add_flower_modal.addEventListener("click", open_modal);

const open_choice_modal = document.querySelector(".modal_choice");
